    ...
    while T < TMAX:
        ...
        while True:
            ...
            if t % checkpoint_interval == 0:
                saver.save(session,  output +"/"+ env_name, global_step=t)
...
def main(_):
    ...
    with tf.Session() as session:
        ...
        parser.add_argument("--env", default="Breakout-v0", help="environment name")
        parser.add_argument("--output", default="out", help="output directory for trained model")
        parser.add_argument("--threads", type=int, default=8, help="number of learning threads")
